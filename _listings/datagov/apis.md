...
created: "2018-03-24"
modified: "2018-03-24"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/tasks/master/_listings/datagov/apis.yaml
...
- name: Data.gov API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tasks/master/_listings/datagov/workers-tasks-id-get.md
- name: Data.gov API Get Workers Tasks
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tasks/master/_listings/datagov/workers-tasks-id-get-postman.md
x-common:
- type: x-blog
