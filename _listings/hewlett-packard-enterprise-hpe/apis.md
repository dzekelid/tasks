...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/tasks/master/_listings/hewlett-packard-enterprise-hpe/apis.md
...
- name: HPE OneSphere API - Get Zones Task Status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tasks/master/_listings/hewlett-packard-enterprise-hpe/zonesidtaskstatus-get-openapi.md
- name: HPE OneSphere API - Get Zones Task Status
  x-api-slug: zonesidtaskstatus-get
  description: Returns the status of the task for the zone
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/HPE-logo.png
