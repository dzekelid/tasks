...
- name: AWS Database Migration Service API Modify Replication Task
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/tasks/master/_listings/aws-database-migration-service/action-modifyreplicationtask-get.md
x-common:
